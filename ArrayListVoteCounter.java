...
public class ArrayListVoteCounter {
    ...
    /**
     * Create new ArrayVoteCounter with file Collect election data
     */
    public ArrayListVoteCounter() {
        // IMPLEMENT
        this.votes = new ArrayList<>();
        this.spoiledVotes = new ArrayList<>();
        this.sithSenateMembers = new SithSenateMember[4];
    ...
    /**
     * Display results Show percent of votes earned by each candidate
     */
    public void reportResults() {
        ...
        for (SithSenateMember sithSenateMember : sithSenateMembers) {
            System.out.println("Darth " + sithSenateMember.getSurname() + ": "
                    + getSithSenateMemberVotes(sithSenateMember.getFullName()) + " votes, "
                    + df.format(sithSenateMember.getNumVotes() / (float) validVotes * 100) + "%.");
        }
     ...
     * contents. Generates decent variation among the candidates.
     */
